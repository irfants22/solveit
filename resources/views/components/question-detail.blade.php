                ...
                <div class="mb-6 pb-4 border-b border-gray-200">
                    <div class="flex items-center space-x-3">
                        ...
                        <form id="delete-question-form" action="{{ route('questions.destroy', $question->id) }}"
                            ...
                            @method('DELETE')
                            <button type="submit"
                                class="inline-flex items-center px-4 py-2 text-sm font-medium text-red-600 bg-red-50 rounded-lg hover:bg-red-100 transition-colors duration-200 cursor-pointer">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="px-6 pb-6">
        <div class="flex items-center gap-6 pt-4 border-t border-gray-200">
            ...
            <div class="flex items-center text-gray-500 text-sm">
                ...
                <span class="font-medium">{{ $question->answers->count() ?? 0 }} Jawaban</span>
            </div>
